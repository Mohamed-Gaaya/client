...
const AddPack = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/packs', formData, {
        headers: {
      ...
      alert(error.response?.data?.error || error.message || 'Failed to create pack');
    }
  };
    ...
    <div className="flex">
      ...
      <div className="flex-1">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          <h2 className="text-3xl font-bold mb-6">Create New Pack</h2>
